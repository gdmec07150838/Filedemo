package com.example.wengzipeng.diledemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fExternalStorageDirectory= Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MUSIC);
        fExternalStoragePublicDirectory=Environment.getExternalStorageDirectory();
    ...
    public void setfExternalStoragePublicDirectory(View v){
